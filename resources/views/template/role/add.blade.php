    ...
    <div class="col-md-12">
        <div class="box box-default collapsed-box box-usuario">
            <div class="box-header with-border usuario-header-box">
                ...
                <h3 class="sub-titulos">Adicionar Nova</h3>
            </div>
        </div>
    </div>
    <!-- FIM DO CABEÇALHO  -->
            ...
            <form role="form" action="" method="POST">
                ...
                <div class="col-md-12 col-unica">
                    ...
                    <div class="form-group col-md-6">
                        <label>ID</label>
                        <input name="id" type="text" value="{!! ($role->id)?($$role->id):(old('id')) !!}" class="form-control" placeholder="ID ..." / disabled>
                    </div><!-- ID-->
                    <!--NOME-->
                    <div class="form-group col-md-6">
                        <label>Nome</label>
                    ...
                    <div class="me-col-12 box-botao-submit" >
                        <a href="{!! url('/roles') !!}" class="botao-cancelar-adicionar-usuario" data-toggle="tooltip" data-placement="top"  title="Cancelar">
