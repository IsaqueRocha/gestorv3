...
<div class="row">
    <div class="col-md-6">
        <div class="row">
            ...
            <div class="form-group col-md-3">
                <label>Entrada</label>
                <input name="entrance_date" type="text" value="{!! ($user->entrance_date)?($user->entrance_date->format('d/m/Y')):(old('entrance_date')) !!}" class="form-control" placeholder="dd/mm/aaaa" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
            </div>

            <!-- SAÍDA -->
            <div class="form-group col-md-3">
                <label>Saída</label>
                <input name="exit_date" type="text" value="" class="form-control" placeholder="dd/mm/aaaa" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
            </div>
        </div>
    </div>
